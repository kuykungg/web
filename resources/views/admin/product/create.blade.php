              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="size" class="form-control" id="basic-default-detail">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-detail">color</label>
                        <div class="col-sm-10">
                          <input type="text" name="color" class="form-control" id="basic-default-detail">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-detail">tool</label>
                        <div class="col-sm-10">
                          <input type="text" name="tool" class="form-control" id="basic-default-detail">
                        </div>
                    </div>
                    <div class="row mb-3">
